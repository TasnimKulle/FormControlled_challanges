  ...
  return (
    <div className="min-h-screen bg-zinc-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8 ring-1 ring-zinc-900/5">
        ...
        <div className="bg-zinc-50 mt-2 p-3 rounded-xl">
          <h2 className="font-semibold text-center "> Preview U Aplication</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <p>{formData.agreeToTerms ? "Yes" : "No"}</p>
          </div>
          <div className="flex items-center gap-2">
            <strong>Notify</strong>
            <p>{formData.notifications ? "Yes" : "No"}</p>
          </div>
        </div>
      </div>
    </div>
